                ...
                while($row = $result->fetch_assoc()){
                    ...
                    echo "<tr height='60px'>
                        ...
                        <td style='font-size: 20px;' width=20% align='center'>
                            <button class='wrapper' style='font-size: 18px; height:40px; background-color: #E06363;  margin:5px; cursor:pointer;' btnid=$id><a href='order_confirm.php' style='padding-right:20px; padding-left:-30px;'>Receive</a></button>
                        </td>
                    </tr>";
                }
            ?>
